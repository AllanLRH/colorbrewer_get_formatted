...
parser.add_argument('-c', '--copy', help='Put the color matrix in the clipboard', action='store_true', default=True)
parser.add_argument('-p', '--print', help='Print the color matrix', action='store_true', default=False)
